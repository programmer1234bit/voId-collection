...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'create_order') {
        ...
        $stmt = $conn->prepare("INSERT INTO orders (user_id, amount, full_name, phone, address, city, state, tx_id, items, status) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, 'pending')");
        $stmt->bind_param("idsssssss", $user_id, $amount, $full_name, $phone, $address, $city, $state, $tx_id, $items);
