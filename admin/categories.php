...
.form-group input, .form-group textarea { width: 100%; padding: 10px; background: #111; border: 1px solid #333; border-radius: 6px; color: #fff; }
.form-group input:focus, .form-group textarea:focus { outline: none; border-color: #FFD93D; }
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="action-btns">
                                    <a href="?action=edit&id=<?php echo $category['id']; ?>" class="btn btn-secondary">Edit</a>
                                    <a href="?action=delete&id=<?php echo $category['id']; ?>" class="btn btn-danger" onclick="return confirm('Delete this category?')">Delete</a>
                                </div>
                            </td>
                        </tr>
                    <?php endforeach; ?>
