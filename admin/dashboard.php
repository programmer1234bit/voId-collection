...
.logout-btn:hover { background: #ff5555; }

.stats { display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 20px; margin-bottom: 30px; }
.stat-card { background: #111; padding: 25px; border-radius: 8px; border-left: 4px solid #FFD93D; }
.stat-number { font-size: 32px; font-weight: bold; color: #FFD93D; margin-bottom: 5px; }
    ...
    <div class="main-content">
        ...
        <div class="content-area">
            ...
            <p style="color: #ccc; line-height: 1.8;">
                This is your central hub for managing the Void Food Collection platform. Use the sidebar to navigate to different sections:
            </p>
        ...
        <div class="content-area" style="margin-top: 30px;">
            ...
            <form method="post">
                <div style="margin-bottom: 15px;">
                    <label for="current_password" style="display: block; margin-bottom: 5px; color: #ccc;">Current Password:</label>
                    <input type="password" id="current_password" name="current_password" required style="width: 100%; padding: 10px; background: #1a1a1a; border: 1px solid #333; border-radius: 5px; color: #fff;">
                </div>
                <div style="margin-bottom: 15px;">
                    <label for="new_password" style="display: block; margin-bottom: 5px; color: #ccc;">New Password:</label>
                    <input type="password" id="new_password" name="new_password" required style="width: 100%; padding: 10px; background: #1a1a1a; border: 1px solid #333; border-radius: 5px; color: #fff;">
                </div>
                <div style="margin-bottom: 15px;">
                    <label for="confirm_password" style="display: block; margin-bottom: 5px; color: #ccc;">Confirm New Password:</label>
                    <input type="password" id="confirm_password" name="confirm_password" required style="width: 100%; padding: 10px; background: #1a1a1a; border: 1px solid #333; border-radius: 5px; color: #fff;">
                </div>
