...
<body>
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Welcome to Void Food Collection ("we", "our", or "us"). We are committed to protecting your privacy and
                ensuring you have a positive experience on our website and services. This Privacy Policy explains how we
                collect, use, disclose, and otherwise process your personal information.</p>
            ...
            <ul>
                <li><strong>Service Providers:</strong> Payment processors and delivery partners who need information to
                    fulfill orders</li>
            ...
            <ul>
                <li><strong>Access:</strong> You can access your account information at any time by logging into your
                    profile</li>
                <li><strong>Correction:</strong> You may update or correct your information through your account
                    settings</li>
                <li><strong>Deletion:</strong> You can request deletion of your account and associated data by
                    contacting us</li>
                <li><strong>Opt-out:</strong> You can manage your communication preferences in your account settings
                </li>
            </ul>

            <h2>7. Cookies and Tracking</h2>
            <p>Our website may use cookies and similar tracking technologies to enhance your experience. These help us
                remember your preferences and analyze how you use our services. You can control cookie settings through
                your browser.</p>
            ...
            <p>Our services are not directed to children under the age of 13. We do not knowingly collect personal
                information from children under 13. If we become aware that we have collected such information, we will
                take steps to delete it.</p>
            ...
            <p>We may update this Privacy Policy from time to time. We will notify you of significant changes by posting
                ...
                indicates your acceptance of the updated policy.</p>
