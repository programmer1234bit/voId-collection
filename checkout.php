...
<body>
            ...
            <form id="checkoutForm" class="payment-form">
                ...
                <div class="form-section">
                    ...
                    <div class="payment-methods">
                        <button type="button" class="method-btn active" data-method="mobile_money">📱 Mobile
                            Money</button>
                    </div>
                    ...
                    <div id="mobilemoneySection">
                        ...
                        <div class="networks-grid">
                            <button type="button" class="network-btn active" data-network="MTN" data-country="Ghana"
                                data-currency="GHS">🇬🇭 MTN<br><small>Ghana</small></button>
                            <button type="button" class="network-btn" data-network="VODAFONE" data-country="Ghana"
                                data-currency="GHS">🇬🇭 Vodafone<br><small>Ghana</small></button>
                            <button type="button" class="network-btn" data-network="AIRTEL" data-country="Tanzania"
                                data-currency="TZS">🇹🇿 Airtel<br><small>Tanzania</small></button>
                            <button type="button" class="network-btn" data-network="TIGO" data-country="Tanzania"
                                data-currency="TZS">🇹🇿 Tigo<br><small>Tanzania</small></button>
                            <button type="button" class="network-btn" data-network="MPESA" data-country="Kenya"
                                data-currency="KES">🇰🇪 M-Pesa<br><small>Kenya</small></button>
                            <button type="button" class="network-btn" data-network="HALOTEL" data-country="Tanzania"
                                data-currency="TZS">🇹🇿 Halotel<br><small>Tanzania</small></button>
                        </div>
    ...
    <script>
        ...
        async function processPayment() {
            ...
            try {
                const payload = {
                    ...
                    items: cart // SECURITY: Send items so backend can recalculate total
                };
                ...
                if (response.ok && data.link) {
                    ...
                    await saveOrder(data.reference, data.chargeId, fullName, email, phone, address, city, state);
         ...
         */
        async function saveOrder(txId, chargeId, fullName, email, phone, address, city, state) {
